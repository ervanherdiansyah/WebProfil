...
namespace App\Http\Controllers\dashboard\aksescepat\berita;
...
class AdminBeritaController extends Controller
{
    ...
    public function index()
    {
        ...
        $berita1 = ModelBerita::first();
        $kategori = ModelBeritaKategori::get();
        return view('dashboard.aksescepat.berita', compact('kategori', 'berita','berita1'));
    }
