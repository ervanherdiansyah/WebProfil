    ...
    <section id="about" class="visimisi">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Visi, Misi, dan Tujuan<br>Madrasah Tsanawiyah Satu Atap (MTs-SA) Al-Istiqomah Cianjur</h2>
          ...
          <div class="text-center">
            <div class="content visimisi-content" >
              ...
              <p class="fst-italic text-visimisi text-center">
                “Mencetak Generasi Mandiri Penerus Ulama”
              </p>

              <h3>Misi</h3>
              <!-- <ol class="text-visimisi justify-content-center">
              ...
              <p class="fst-italic text-visimisi text-center">
                Melaksanakan Pendidikan berbasis Ilmu salafiyah dan akhlaqul karimah
              </p>
