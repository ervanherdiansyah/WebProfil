    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 justify-content-center align-items-center">
          ...
          <div class="col-xl-3 col-md-6 col-sm-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
          ...
          <div class="col-xl-3 col-md-6 col-sm-6 d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
    ...
    <section id="team" class="team portfolio sections-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 justify-content-center align-items-center">
          ...
          <div class="col-xl-2 col-md-4 col-sm-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <img src="{{asset('assets')}}/img/team/team-1.jpg" class="img-fluid" alt="">
              <h4>Walter White</h4>
              <span>Sekretaris</span>
