                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ url('/admin/aksescepat/berita') }}">Berita</a></li>
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <!-- form start -->
                                        <form action="{{ url('/admin/aksescepat/berita/create') }}" method="POST"
                                                    ...
                                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <!-- form start -->
                                                                <form
                                                                    action="{{ url('/admin/aksescepat/berita/update') }}/{{ $data->id }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Deskripsi</label>
                                                                        <textarea class="form-control @error('body') is-invalid @enderror" name="body" id="body{{$key}}"
                                                                            placeholder="Enter..." value="">{{ $data->body }}</textarea>
                                                                        @error('body')
                                                                            <div class="invalid-feedback">{{ $message }}
                                                                            </div>
                                                                        @enderror
                                                    ...
                                                    <div class="modal-dialog modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="{{ url('/admin/aksescepat/berita/destroy') }}/{{ $data->id }}"
                        ...
                        <div class="modal fade text-left" id="tambah1" tabindex="-1" aria-labelledby="tambahLabel"
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <!-- form start -->
                                        <form action="{{ url('/admin/aksescepat/berita/create/kategori') }}"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- form start -->
                                                            <form
                                                                action="{{ url('/admin/aksescepat/berita/update/kategori') }}/{{ $data->id }}"
                                                                method="POST" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <label>Kategori</label>
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="{{ url('/admin/aksescepat/berita') }}"
                                                                class="btn btn-success btn-sm">kembali</a>
                                                            <a href="{{ url('/admin/aksescepat/berita/destroy/kategori') }}/{{ $data->id }}"
                                                                class="btn btn-danger btn-sm">delete</a>
                                                        </div>
                                                    </div>
                                                </div>
